        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <h3 class="fw-light">Antonio Felipe S. Lima</h3>
            ...
            <div class="col-lg-7 mx-auto">
                ...
                <form method="post" action="script.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" placeholder="Fulano da Silva Santos">
                    </div>
                    <div class="mb-3">
                        <label for="telefone" class="form-label">Telefone:</label>
                        <input type="number" class="form-control" id="telefone" name="telefone" placeholder="(71) 3241-3010">
                    </div>
                    <div class="mb-3">
                        <label for="observacao" class="form-label">Observação:</label>
                        <textarea class="form-control" id="observacao" name="observacao" placeholder="Alguma Observação Aqui !" rows="3"></textarea>
                    </div>
        ...
        <div class="album py-5 bg-body-tertiary">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    include 'Cliente.php';
                    ?>
                    <?php $clientes = Cliente::obterTodos(); ?>
